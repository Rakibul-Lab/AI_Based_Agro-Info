...
<body>
    ...
    <div class="container-fluid position-relative nav-bar p-0">
        ...
        <a class="nav-link active" href="index.php">Find Workers</a>
        <a class="nav-link" href="login.php">Login</a>
        <a class="nav-link" href="register.php">Register as worker</a>
    ...
    <div class="container">
      <div class="heading_container">
        <hr>
        <h2>
          From Here you can search for workers you need
        </h2>
      </div>
    </div>
