...
<div class="form-group">
          ...
          <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button" id="submit"><a href="login.php">Login</a></button>

	</form>


	<span class="checkout-subtitle outer-top-xs">Sign Up From here and then click on Login  </span>
	<div class="checkbox">
