...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<span style="color:red;" >
		...
		<a href="signup.php" class="forgot-password pull-right">Don't Have an account? Then Signup.</a>
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="login">Login</button>
		  <button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="Signup"><a href="signup.php">Signup</a></button>
	</form>					
</div>
<!-- Sign-in -->
